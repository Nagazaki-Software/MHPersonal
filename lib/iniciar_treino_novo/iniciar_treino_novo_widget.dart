...
import 'iniciar_treino_novo_model.dart';
export 'iniciar_treino_novo_model.dart';

/// fazer exercício com timer e video
class IniciarTreinoNovoWidget extends StatefulWidget {
  const IniciarTreinoNovoWidget({
    super.key,
  ...
  static String routeName = 'iniciarTreinoNovo';
  static String routePath = 'iniciarTreinoNovo';

  @override
  State<IniciarTreinoNovoWidget> createState() =>
      _IniciarTreinoNovoWidgetState();
}

class _IniciarTreinoNovoWidgetState extends State<IniciarTreinoNovoWidget> {
  late IniciarTreinoNovoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => IniciarTreinoNovoModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'iniciarTreinoNovo'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('INICIAR_TREINO_NOVO_iniciarTreinoNovo_ON');
      logFirebaseEvent('iniciarTreinoNovo_firestore_query');
      _model.treinoslist = await queryCreateTreinosRecordOnce(
        parent: currentUserReference,
        queryBuilder: (createTreinosRecord) => createTreinosRecord.where(
          'uidTreinos',
      ...
      await openrouterGenerateText(
        ...
        safeSetState(() => _model.tempomedio = generatedText);
      });
    });
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<CreateTreinosRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final iniciarTreinoNovoCreateTreinosRecord = snapshot.data!;

        return Title(
            title: 'iniciarTreinoNovo',
                  ...
                  desktop: false,
                    ...
                    ? AppBar(
                        ...
                        leading: FlutterFlowIconButton(
                          ...
                          onPressed: () async {
                            logFirebaseEvent(
                                'INICIAR_TREINO_NOVO_arrow_back_rounded_I');
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      FlutterFlowIconButton(
                                        ...
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'INICIAR_TREINO_NOVO_play_arrow_ICN_ON_TA');
                                      ...
                                      FlutterFlowIconButton(
                                        ...
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'INICIAR_TREINO_NOVO_PAGE_stop_ICN_ON_TAP');
                                          logFirebaseEvent('IconButton_timer');
                                      ...
                                      FlutterFlowIconButton(
                                        ...
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'INICIAR_TREINO_NOVO_refresh_ICN_ON_TAP');
                                          logFirebaseEvent('IconButton_timer');
                          ...
                          child: Column(
                            ...
                            children: [
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            'sbjsnjtv' /* Detalhes do Exercício */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .headlineSmall
                                              .override(
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: Wrap(
                                                          ...
                                                          clipBehavior:
                                                              Clip.none,
                                                          children: [
                                                            if (listViewSeriesRepeticoesRecord
                                                                        .seriesRep !=
                                                                    null &&
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        wrapWithModel(
                                          model: _model.feitopelomhModel,
                                          updateCallback: () =>
                                              safeSetState(() {}),
                                          child: FeitopelomhWidget(),
                                        ),
                                        Column(
                                          mainAxisSize: MainAxisSize.min,
                                          children: [
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'INICIAR_TREINO_NOVO_CONCLUIR_EXERCCIO_BT');
                                  logFirebaseEvent('Button_update_app_state');
                                  FFAppState().addToTreinoconcluidohoje(
                                      widget!.treino!);
                                  FFAppState().update(() {});
