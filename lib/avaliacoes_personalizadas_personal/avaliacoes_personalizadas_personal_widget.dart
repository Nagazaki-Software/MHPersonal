...
import 'avaliacoes_personalizadas_personal_model.dart';
export 'avaliacoes_personalizadas_personal_model.dart';

/// pagina com todas as avaliacao personalizada deste aluno sem medidas so as
/// avaliacoes e para criar
class AvaliacoesPersonalizadasPersonalWidget extends StatefulWidget {
  const AvaliacoesPersonalizadasPersonalWidget({
    super.key,
    required this.users,
  });
  ...
  static String routeName = 'avaliacoesPersonalizadasPersonal';
  static String routePath = 'avaliacoesPersonalizadasPersonal';

  @override
  State<AvaliacoesPersonalizadasPersonalWidget> createState() =>
      _AvaliacoesPersonalizadasPersonalWidgetState();
}

class _AvaliacoesPersonalizadasPersonalWidgetState
    extends State<AvaliacoesPersonalizadasPersonalWidget> {
  ...
  void initState() {
    super.initState();
    _model =
        createModel(context, () => AvaliacoesPersonalizadasPersonalModel());
  ...
  Widget build(BuildContext context) {
    return Title(
        title: 'avaliacoesPersonalizadasPersonal',
                ...
                ? PreferredSize(
                    ...
                    child: AppBar(
                      ...
                      leading: FlutterFlowIconButton(
                        ...
                        onPressed: () async {
                          logFirebaseEvent(
                              'AVALIACOES_PERSONALIZADAS_PERSONAL_arrow');
                      ...
                      title: Text(
                        FFLocalizations.of(context).getText(
                          '76gbcn7g' /* Avaliações Personalizadas */,
                        ),
                      ...
                      actions: [
                        FlutterFlowIconButton(
                          ...
                          onPressed: () async {
                            logFirebaseEvent(
                                'AVALIACOES_PERSONALIZADAS_PERSONAL_add_c');
                                      ...
                                      return SingleChildScrollView(
                                        child: Column(
                                          ...
                                          children: List.generate(
                                              columnAvaliacaoPersonalizadaRecordList
                                                  .length, (columnIndex) {
                                            final columnAvaliacaoPersonalizadaRecord =
                                                columnAvaliacaoPersonalizadaRecordList[
                                                    columnIndex];
                                            return Padding(
                                                          ...
                                                          children: [
                                                            FFButtonWidget(
                                                              onPressed:
                                                                  () async {
                                                                logFirebaseEvent(
                                                                    'AVALIACOES_PERSONALIZADAS_PERSONAL_VER_D');
                                                                logFirebaseEvent(
                                                                    'Button_navigate_to');
                                                                if (Navigator.of(
                                                                        context)
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'AVALIACOES_PERSONALIZADAS_PERSONAL_Row_h');
